...
<x-jet-form-section submit="updateProfileInformation" class="mt-12">
    ...
    <x-slot name="form">
        ...
        @if (Laravel\Jetstream\Jetstream::managesProfilePhotos())
                <!-- Profile Photo -->
                <div x-data="{photoName: null, photoPreview: null}" class="col-span-6 mt-4 sm:col-span-3 px-4">
 ...
 {{--               <!--BG Profile Photo -->
                <div x-data="{photoName: null, photoPreview: null}" class="col-span-6 mt-4 sm:col-span-4 px-4">
                    <div class="border-2 col-span-2 rounded-md" >
                        <!-- Profile Photo File Input -->
                        <input type="file" class="hidden"
                               wire:model="photo"
        ...
        @endif
            ...
            <div class="text-left col-span-6 sm:col-span-3 mt-2 px-4" >
                <!-- Name -->
                <div class="my-2">
            ...
            <div class="text-left col-span-6 sm:col-span-3 mt-1.5 px-4" >
                <!-- Username -->
                <div class="mt-2.5">
