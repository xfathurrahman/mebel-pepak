                    ...
                    <form class="mr-3 ml-auto right-0">
                        <div class="input-group">
                            <label style="margin-bottom: 0; margin-top: 2px; margin-left: 5px;">
                                <input type="text" class="form-control" placeholder="Cari Carousel">
                            </label>
                ...
                <div class="card-body p-0">
                    <div class="table-responsive">
                        <table class="mytable table-striped p-0">
                                    ...
                                    <tr id="cid{{$carousel->id}}">
                                        <td style="width: 30%"  class="td p-0 pl-4 pb-2 text-center">
                                            <div class="flex-column-product custom-control-child">
                                                ...
                                                <img style="display: block; margin-left: auto; margin-right: auto;" class="img c-thumb-d" alt="image"
                                                     data-toggle="tooltip" title=""  src="{{ asset("storage/carousel-image")."/".$carousel->image }}">
                                            </div>
                                        </td>
                                        ...
                                        <td class="text-center">
                                            {{ "#".number_format($carousel->id) }}
                                        </td>
                                        <td class="text-center">
                                            <div class="badge badge-success">{{ $carousel->slug }}</div>
                                        </td>
                                        <td class="text-center">
                                            ...
                                            <a href="#" class="btn btn-danger delete"
                                               ...
                                               data-carousel_id="{{$carousel->id}}"><i class="fas fa-times"></i> Delete
                                            </a>
                                        </td>
                                    </tr>
                                @endforeach
                            @else
                                <tr>
                                    <td colspan="7" class="text-center text-white py-32 bg-red-400">Anda belum mempunyai Carousel.</td>
                                </tr>
                            @endif
                            </tbody>
                        </table>
        ...
        <div class="modal-content">
            ...
            <form action="#" method="post" id="delete_carousel_form">
                ...
                <div class="modal-body">
                    <h5>Kamu ingin menghapus Carousel ini ?</h5>
                </div>
